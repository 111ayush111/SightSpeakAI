...
import React, { useState, useEffect } from 'react';
import { useSightSpeak } from './hooks/useSightSpeak';
import { ScreenShareControl } from './components/ScreenshotUploader';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Removed setCaptureHandleConfig due to lack of support
  }, []);
